...
/**
 * Title: Search banner
 * Slug: horseclub/hidden-search-banner
...
<div class="wp-block-group"><!-- wp:query-title {"type":"search","style":{"typography":{"textAlign":"center"}},"textColor":"overlay"} /-->
...
<p class="has-overlay-color has-text-color">Search</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
